            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="http://example.com"
                        ...
                        class="nav-link messages-toggle"><i class="icon-email"></i><span
                            class="badge dashbg-1">{{ Auth::user()->unreadNotifications->count() }}</span></a>
                    <div aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages"><a href="#"
                            ...
                            <div class="content"> <strong class="d-block">Wohoo!!</strong><span class="d-block">{{ $notification->data['message'] }}</span><small class="date d-block">10:30pm</small></div>
                        </a>@endforeach</div>
